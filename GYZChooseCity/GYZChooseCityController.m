    ...
    if (_cityDatas == nil) {
        ...
        for (NSDictionary *groupDic in array) {
            ...
            for (NSDictionary *dic in [groupDic objectForKey:@"citys"]) {
                ...
                city.capital = [dic objectForKey:@"capital"];
    ...
    [geocoder reverseGeocodeLocation:currentLocation completionHandler:^(NSArray *array, NSError *error)
     {
         if (array.count >0)
         {
             ...
             if (currCity != nil) {
                 ...
                 currCity = [NSString stringWithFormat:@"%@ %@",placemark.administrativeArea,placemark.locality];
             }else {
             ...
             if (self.localCityData.count <= 0) {
                 ...
                 city.capital = placemark.administrativeArea;
